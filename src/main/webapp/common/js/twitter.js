...
(function (a, b) {
    ...
    function L(a) {
        var b;
        for (b in a) {
            if (b === "data" && q.isEmptyObject(a[b])) continue;
    ...
    function mb(a, b, c) {
        b = b || 0;
        if (q.isFunction(b)) return q.grep(a, function (a,
            d) {
                var e = !! b.call(a, d, a);
                return e === c
            });
        if (b.nodeType) return q.grep(a, function (a, d) {
                return a === b === c
            });
        if (typeof b == "string") {
            ...
            if (hb.test(b)) return q.filter(b, d, !c);
            b = q.filter(b, d)
        }
        return q.grep(a, function (
        a, d) {
    ...
    function Gb(a, b) {
        if (b.nodeType !== 1 || !q.hasData(a)) return;
        var c, d, e, f = q._data(a),
            g = q._data(b, f),
            i = f.events;
        if (i) {
            delete g.handle;
            g.events = {};
            for (c in i) for (d = 0, e = i[c].length; d < e; d++) q.event.add(b, c, i[c][d])
        }
    ...
    function Hb(a, b) {
        ...
        if (c === "object") {
            ...
            q.support.html5Clone && a.innerHTML && !q.trim(b.innerHTML) &&
                (b.innerHTML = a.innerHTML)
        } else if (c === "input" && yb.test(a.type)) {
            b.defaultChecked = b.checked = a.checked;
            b.value !== a.value && (b.value = a.value)
        } else c === "option" ? b.selected = a.defaultSelected : c === "input" || c === "textarea" ? b.defaultValue = a.defaultValue : c === "script" &&
                b.text !== a.text && (b.text = a.text);
    ...
    function dc(a, b, c, d) {
        ...
        for (; e < 4; e += 2) {
            ...
            if (d) {
                ...
                c !== "margin" && (f -= parseFloat(
                Kb(a, "border" + Yb[e] + "Width")) || 0)
            } else {
    ...
    function ec(a, b, c) {
        var d = b === "width" ? a.offsetWidth : a.offsetHeight,
            e = !0,
            f = q.support.boxSizing && q.css(a, "boxSizing") === "border-box";
        if (d <= 0 || d == null) {
            d = Kb(a, b);
    ...
    function lc(a, b, c, d) {
        var e;
        if (q.isArray(b)) q.each(b, function (b, e) {
                c || hc.test(a) ? d(a, e) : lc(a + "[" + (typeof
                e == "object" ? b : "") + "]", e, c, d)
            });
        else if (!c && q.type(b) === "object") for (e in b) lc(a + "[" + e + "]", b[e], c, d);
        else d(a, b)
    }
    function Cc(a) {
        return function (b, c) {
            ...
            var d, e, f, g = b.toLowerCase().split(t),
                i = 0,
                j = g.length;
            if (q.isFunction(c)) for (; i < j; i++) {
                    d = g[i];
                    f = /^\+/.test(d);
                    f && (d = d.substr(1) || "*");
                    e = a[d] = a[d] || [];
    ...
    function Dc(a, c, d, e, f, g) {
        ...
        for (; k < l && (m || !i); k++) {
            i = j[k](c, d, e);
            if (typeof i == "string") if (!m || g[i]) i = b;
                else {
    ...
    function Fc(a, c, d) {
        ...
        if (e) for (f in j) if (j[f] && j[f].test(e)) {
                    k.unshift(f);
                    break
                }
        if (k[0] in d) g = k[0];
    ...
    function Gc(a, b) {
        ...
        if (g[1]) for (c in a.
            converters) j[c.toLowerCase()] = a.converters[c];
        for (; e = g[++k];) if (e !== "*") {
                if (i !== "*" && i !== e) {
                    c = j[i + " " + e] || j["* " + e];
                    if (!c) for (d in j) {
    ...
    b, c) {
        var d, e = 0,
            f = 0,
            g = Vc.length,
            i = q.Deferred().always(function () {
                delete j.elem
            }),
            j = function () {
                var b = Qc || Xc(),
                    c = Math.max(0, k.startTime + k.duration - b),
                    d = c / k.duration || 0,
                    e = 1 - d,
                    f = 0,
                    g = k.tweens.length;
                for (; f < g; f++) k.tweens[f].run(e);
                ...
                createTween: function (b, c, d) {
                    var e = q.Tween(a, k.
                    opts, b, c, k.opts.specialEasing[b] || k.opts.easing);
                    k.tweens.push(e);
                    return e
                },
                stop: function (b) {
        ...
        return k.progress(k.opts.progress).done(k.opts.done, k.opts.complete).fail(k.opts.fail).
    ...
    function _c(a, b, c) {
        ...
        if (a.nodeType === 1 && ("height" in b || "width" in b)) {
            ...
            q.css(a, "display") === "inline" && q.css(a, "float") === "none" && (!q.support.inlineBlockNeedsLayout ||
                fc(a.nodeName) === "inline" ? o.display = "inline-block" : o.zoom = 1)
        }
        if (c.overflow) {
            o.overflow = "hidden";
    ...
    q.extend({
        ...
        ready: function (a) {
            if (a === !0 ? --q.readyWait : q.isReady) return;
            if (!e.body) return setTimeout(q.ready, 1);
            q.isReady = !0;
            if (a !== !0 && --q.readyWait > 0) return;
            d.resolveWith(e, [q]);
        ...
        isPlainObject: function (a) {
            if (!a || q.type(a) !== "object" || a.nodeType || q.isWindow(a)) return !1;
            try {
                if (a.constructor && !o.call(a, "constructor") && !o.call(a.constructor.prototype, "isPrototypeOf")) return !1
            } catch (c) {
                return !1
            }
            var d;
        ...
        parseHTML: function (a, b, c) {
            ...
            b = b || e;
            if (d = w.exec(a)) return [b.createElement(d[1])];
        ...
        parseJSON: function (b) {
            ...
            if (x.test(b.replace(z, "@").replace(A, "]").replace(y, ""))) return (new Function("return " + b))();
        ...
        map: function (a, c, d) {
            var e, f, g = [],
                i = 0,
                j = a.length,
                k = a instanceof q || j !== b && typeof j == "number" &&
        ...
        access: function (a, c, d, e, f, g, i) {
            ...
            if (d && typeof d == "object") {
                for (l in d) q.access(a, c, l, d[l], 1, g, e);
                f = 1
            } else if (e !== b) {
                ...
                if (c) for (; l < m; l++) c(a[l], d, j ? e.call(a[l], l, c(a[l], d)) : e, i);
                f = 1
            }
    ...
    q.ready.promise = function (b) {
        if (!d) {
            d = q.Deferred();
            if (e.readyState === "complete") setTimeout(q.ready, 1);
    ...
    q.Callbacks = function (a) {
        ...
        var c, d, e, f, g, i, j = [],
            ...
            b) {
                ...
                g = j.length;
                e = !0;
                for (; j && i < g; i++) if (j[i].apply(b[0], b[1]) === !1 && a.stopOnFalse) {
                        c = !1;
                        break
                    }
                e = !1;
    ...
    q.extend({
        ...
        when: function (a) {
            var b = 0,
                c = l.call(arguments),
                d = c.length,
                e = d !== 1 || a && q.isFunction(a.promise) ? d : 0,
                f = e === 1 ? a : q.Deferred(),
                g = function (a, b, c) {
                    return function (d) {
                        b[a] = this;
            ...
            if (d > 1) {
                ...
                j = new Array(d);
                k = new Array(d);
                for (; b < d; b++) c[b] && q.isFunction(c[b].promise) ? c[b].promise().done(g(b, k, c)).fail(f.reject).progress(g(b, j, i)) : --e
            }
            e || f.resolveWith(k,
            c);
            return f.promise()
    ...
    q.extend({
        ...
        data: function (a, c, d, e) {
            if (!q.acceptData(a)) return;
            var f, g, i = q.expando,
                j = typeof c == "string",
                k = a.nodeType,
                l = k ? q.cache : a,
                m = k ? a[i] : a[i] && i;
            if ((!m || !l[m] || !e && !l[m].data) && j && d === b) return;
            m || (k ? a[i] = m = q.deletedIds.pop() || q.guid++ : m = i);
            if (!l[m]) {
                l[m] = {};
                k || (l[m].toJSON = q.noop)
            }
            if (typeof c == "object" || typeof c == "function") e ? l[m] = q.extend(l[m], c) : l[m].data = q.extend(l[m].data, c);
            f = l[m];
            if (!e) {
                f.data || (f.data = {});
                f = f.data
        ...
        removeData: function (a, b, c) {
            ...
            var d, e, f, g = a.nodeType,
                i = g ? q.cache : a,
                j = g ? a[q.expando] : q.expando;
            if (!
                i[j]) return;
            if (b) {
                d = c ? i[j] : i[j].data;
                if (d) {
                    if (!q.isArray(b)) if (b in d) b = [b];
                        else {
                            b = q.camelCase(b);
                            b in d ? b = [b] : b = b.split(" ")
                        }
                    for (e = 0, f = b.length; e < f; e++) delete d[b[e]];
                    if (!(c ? L : q.isEmptyObject)(d)) return
                }
            }
            if (!c) {
                delete i[j].data;
    ...
    q.fn.extend({
            ...
            a == "string") {
                ...
                for (c = 0, d = this.length; c < d; c++) {
                    ...
                    if (e.nodeType === 1) if (!e.className && b.length === 1) e.className = a;
                            ...
                            f = " " + e.className + " ";
                            for (g = 0, i = b.length; g < i; g++) f.indexOf(" " + b[g] + " ") < 0 && (f += b[g] + " ");
        ...
        hasClass: function (a) {
            var b = " " + a + " ",
                c = 0,
                d = this.length;
            for (; c < d; c++) if (this[c].nodeType === 1 && (" " + this[c].className + " ").replace(P, " ").indexOf(b) >= 0) return !0;
            return !1
        },
        val: function (a) {
            var c, d, e, f = this[0];
            if (!arguments.length) {
                if (f) {
                    ...
                    if (c && "get" in c && (d = c.get(f, "value")) !== b) return d;
                    d = f.value;
                    return typeof
    ...
    q.extend({
        ...
        attr: function (a, c, d, e) {
            ...
            if (e && q.isFunction(q.fn[c])) return q(a)[c](d);
            if (typeof a.getAttribute == "undefined") return q.prop(a, c, d);
            i = j !== 1 || !q.isXMLDoc(a);
            if (i) {
                c = c.toLowerCase();
                g = q.attrHooks[c] || (
            ...
            if (d !== b) {
                ...
                if (g && "set" in g && i && (f = g.set(a, d, c)) !== b) return f;
                a.setAttribute(c, d + "");
                return d
            }
            if (g && "get" in g && i && (f = g.get(a, c)) !== null) return f;
            f = a.getAttribute(c);
            return f === null ? b : f
        },
        removeAttr: function (
        ...
        attrHooks: {
            type: {
                set: function (a, b) {
                    if (R.test(a.nodeName) && a.parentNode) q.error("type property can't be changed");
            ...
            value: {
                ...
                set: function (a, b, c) {
                    if (M && q.nodeName(a, "button")) return M.set(a, b, c);
                    a.value = b
                }
            }
        },
    ...
    q.each(["radio", "checkbox"], function () {
        q.valHooks[this] = q.extend(q.valHooks[this], {
            set: function (a, b) {
                if (q.isArray(b)) return a.checked = q.inArray(q(a).val(), b) >= 0
            }
        })
    });
    ...
    q.event = {
        add: function (a, c, d, e, f) {
            ...
            if (a.nodeType === 3 || a.nodeType === 8 || !c || !d || !(g = q._data(a))) return;
            if (d.handler) {
                p = d;
                d = p.handler;
                f = p.selector
        ...
        remove: function (a, b, c, d, e) {
            ...
            for (f = 0; f < b.length; f++) {
                ...
                k = g[2];
                if (!i) {
                    for (i in n) q.event.remove(a, i + b[f], c, d, !0);
                    continue
                }
                o = q.event.special[i] || {};
        ...
        trigger: function (c, d, f, g) {
            if (!f || f.nodeType !== 3 &&
                f.nodeType !== 8) {
                var i, j, k, l, m, n, o, p, r, s, t = c.type || c,
                    u = [];
                if (bb.test(t + q.event.triggered)) return;
                if (t.indexOf("!") >= 0) {
                    t = t.slice(0, -1);
                    j = !0
                }
                ...
                if ((!f || q.event.customEvent[t]) && !q.event.global[t]) return;
                ...
                d.unshift(c);
                o = q.event.special[t] || {};
                if (o.trigger && o.trigger.apply(f, d) === !1) return;
                r = [
                    [f, o.bindType ||
                            t
                    ]
        ...
        c) {
            ...
            var d, e, f, g, i, j, k, m, n, o, p = (q._data(this, "events") || {})[c.type] || [],
                r = p.delegateCount,
                s = l.call(arguments),
                t = !c.exclusive && !c.namespace,
                u = q.event.special[c.type] || {}, v = [];
            s[0] = c;
            c.delegateTarget = this;
            if (u.preDispatch && u.preDispatch
                .call(this, c) === !1) return;
            if (r && (!c.button || c.type !== "click")) for (f = c.target; f != this; f = f.parentNode || this) if (f.disabled !== !0 || c.type !== "click") {
                        i = {};
                        k = [];
                        for (d = 0; d < r; d++) {
                            m = p[d];
        ...
        fix: function (a) {
            ...
            var b, c, d = a,
                f = q.event.fixHooks[a.type] || {}, g = f.props ? this.props.concat(f.props) : this.props;
            a = q.Event(d);
            for (b = g.length; b;) {
                c = g[--b];
                a[c] = d[c]
    ...
    q.support.submitBubbles || (q.event.special.submit = {
        setup: function () {
            ...
            q.event.add(this, "click._submit keypress._submit", function (a) {
                var c = a.target,
                    d = q.nodeName(c, "input") || q.nodeName(c, "button") ? c.form : b;
    ...
    q.fn.extend({
        on: function (a, c, d, e, f) {
            ...
            if (d == null && e == null) {
                e = c;
                d = c = b
            } else if (e == null) if (typeof c == "string") {
                    e = d;
                    d = b
                } else {
                    e = d;
        ...
        triggerHandler: function (a, b) {
            if (this[0]) return q.event.trigger(a, b, this[0], !0)
        },
        toggle: function (a) {
            var b = arguments,
                c = a.guid || q.guid++,
    ...
    (function (a, b) {
        function fb(a, b, c, d) {
            ...
            if (!j && !d) if (e = Q.exec(a)) if (k = e[1]) {
                        ...
                        } else if (b.ownerDocument && (f = b.ownerDocument
                            .getElementById(k)) && i(b, f) && f.id === k) {
                            c.push(f);
                            return c
                        }
                    } else {
        ...
        function kb(a, b) {
            ...
            while (i) {
                ...
                for (g in e.filter) if ((d = X[g].exec(i)) && (!k[g] || (d = k[g](d)))) {
                        f.push(c = new r(d.shift()));
                        i = i.slice(c.length);
                        c.type = g;
                        c.matches = d
        ...
        function lb(a, b, d) {
            ...
            return b.first ? function (b, c, d) {
                ...
                } else while (b = b[e]) if (f || b.nodeType === 1) if (a(b, d, i)) return b
            }
        }
        function mb(a) {
        ...
        function nb(a, b, c, d, e) {
            var f, g = [],
                ...
                j = a.length,
                k = b != null;
            for (; i < j; i++) if (f = a[i]) if (!c || c(f, d, e)) {
                        g.push(f);
                        k && b.push(i)
                    }
            return g
        ...
        function ob(a, b, c, d, e, f) {
            ...
            return A(function (f, g, i, j) {
                ...
                if (d) {
                    ...
                    d(k, [], i, j);
                    l = k.length;
                    while (l--) if (m = k[l]) s[o[l]] = !(r[o[l]] = m)
                }
                if (f) {
                    if (e || a) {
                        if (e) {
                        ...
                        l = s.length;
                        while (l--)(m = s[l]) && (
                            k = e ? z.call(f, m) : n[l]) > -1 && (f[k] = !(g[k] = m))
                    }
                } else {
        ...
        function pb(a) {
            ...
            for (; j < f; j++) if (c = e.relative[a[j].type]) n = [lb(mb(n), c)];
                else {
            ...
            var d = b.length > 0,
                ...
                g = function (i, j, k, l, n) {
                    var o, p, q, r = [],
                        ...
                        z = n != null,
                        A = m,
                        B = i || f && e.find.TAG("*", n && j.parentNode || j),
                        C = u += A == null ? 1 : Math.E;
                    if (z) {
                        m = j !== s && j;
                        c = g.el
                    ...
                    t +=
                        v;
                    if (d && v !== t) {
                        for (p = 0; q = b[p]; p++) q(y, r, j, k);
                        if (i) {
                            if (t > 0) while (v--)!y[v] && !r[v] && (r[v] = w.call(l));
                            r = nb(r)
                        }
                        x.apply(l, r);
        ...
        function rb(a, b, c) {
            var d = 0,
                e = b.length;
            for (; d < e; d++) fb(a, b[d], c);
            return c
        }
        function sb(a, b, c, d, f) {
            var g, i, k, l, m, n = kb(a),
                o = n.length;
            if (!d && n.length === 1) {
                i = n[0] = n[0].slice(0);
                ...
                for (g = X.POS.test(a) ? -1 : i.length - 1; g >= 0; g--) {
                    k = i[g];
                    if (e.relative[l = k.type]) break;
                    if (m = e.find[l]) if (d = m(k.matches[0].replace(W, ""), S.test(i[0].type) && b.parentNode || b, f)) {
                            i.splice(g, 1);
                            a = d.length && i.join("");
                            if (!a) {
        ...
        var c, d, e, f, g, i, j, k, l, m, n = !0,
            ...
            K = ":(" + G + ")(?:\\((?:(['\"])((?:\\\\.|[^\\\\])*?)\\2|([^()[\\]]*|(?:(?:" +
                J + ")|[^:]|\\\\.)*|.*))\\)|)",
            L = ":(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + F + "*((?:-\\d)?\\d*)" + F + "*\\)|)(?=[^-]|$)",
            M = new RegExp("^" + F + "+|((?:^|[^\\\\])(?:\\\\.)*)" + F + "+$", "g"),
            N = new RegExp("^" + F + "*," + F + "*"),
            O = new RegExp("^" + F + "*([\\x20\\t\\r\\n\\f>+~])" +
                F + "*"),
        ...
        fb.attr = function (a, b) {
            var c, d = g(a);
            d || (b = b.toLowerCase());
            if (c = e.attrHandle[b]) return c(a);
            if (d || bb) return a.getAttribute(b);
        ...
        e = fb.selectors = {
            ...
            find: {
                ...
                TAG: Z ? function (a, b) {
                    if (typeof b.getElementsByTagName !== o) return b.getElementsByTagName(a)
                } : function (a, b) {
                ...
                NAME: db && function (a, b) {
                    if (typeof b.getElementsByName !== o) return b.getElementsByName(name)
                },
                CLASS: cb && function (a, b, c) {
                    if (typeof b.getElementsByClassName !== o && !c) return b.getElementsByClassName(a)
                }
            },
            relative: {
                ">": {
            ...
            pseudos: {
                ...
                empty: function (a) {
                    ...
                    while (a) {
                        if (
                        a.nodeName > "@" || (b = a.nodeType) === 3 || b === 4) return !1;
                        a = a.nextSibling
                    }
                    return !0
                },
        ...
        k = t.compareDocumentPosition ? function (a, b) {
            ...
            c = e.length;
            d = f.length;
            for (var k = 0; k < c && k < d; k++) if (e[k] !== f[k]) return jb(e[k], f[k]);
            ...
            if (i) {
                ...
                fb.matchesSelector = function (b, c) {
                    ...
                    if (!g(b) && !f.test(c) && !e.test(c)) try {
                            var j = i.call(b, c);
                            if (j || a || b.document && b.document.nodeType !== 11) return j
                    } catch (k) {}
    ...
    q.fn.extend({
        find: function (a) {
            ...
            if (typeof a != "string") return q(a).filter(function () {
                    for (b = 0, c = i.length; b < c; b++) if (q.contains(i[b], this)) return !0
                });
        ...
        has: function (a) {
            ...
            return this.filter(function () {
                for (b = 0; b < d; b++) if (q.contains(this, c[b])) return !0
            })
        },
        not: function (a) {
        ...
        add: function (a, b) {
            var c = typeof a == "string" ? q(a, b) : q.makeArray(a && a.nodeType ? [a] : a),
                d = q.merge(this.get(), c);
            return this
    ...
    var ob = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ...
        Eb = Db.appendChild(e.createElement("div"));
    ...
    q.fn.extend({
        ...
        wrapAll: function (a) {
            if (q.isFunction(a)) return this.each(function (
                b) {
        ...
        before: function () {
            if (!kb(this[0])) return this.domManip(arguments, !1, function (
                a) {
        ...
        after: function () {
            if (!kb(this[0])) return this.domManip(arguments, !1, function (a) {
        ...
        remove: function (a, b) {
            var c, d = 0;
            for (;
            (c = this[d]) != null; d++) if (!a || q.filter(a, [c]).length) {
                    if (!b && c.nodeType === 1) {
                        q.cleanData(
        ...
        html: function (a) {
            return q.access(this, function (a) {
                var c = this[0] || {}, d = 0,
                    e = this.length;
                if (a === b) return c.nodeType === 1 ? c.innerHTML.replace(
                    pb, "") : b;
        ...
        domManip: function (a, c, d) {
            ...
            var e, f, g, i, j = 0,
                ...
                l = [],
                m = this.length;
            if (!q.support.checkClone && m > 1 && typeof k == "string" && zb.test(k)) return this.each(function () {
                    q(this).domManip(a, c, d)
                });
            if (q.isFunction(k)) return this
                    .each(function (e) {
                    var f = q(this);
            ...
            if (this[0]) {
                ...
                if (f) {
                    c = c && q.nodeName(f, "tr");
                    for (i = e.cacheable || m - 1; j < m; j++) d.call(c && q
    ...
    q.extend({
        ...
        clean: function (a, b, c, d) {
            var f, g, i, j, k, l, m, n, o, p, r, s, t = b === e && Db,
                u = [];
            ...
            (i = a[f]) != null; f++) {
                typeof i == "number" && (i += "");
                if (!i) continue;
                if (typeof i == "string") if (!ub.test(i)) i = b.createTextNode(i);
                    else {
                        t = t || nb(b);
                        ...
                        if (!q.support.tbody) {
                            ...
                            for (g = o.length - 1; g >= 0; --g) q.nodeName(o[g], "tbody") && !o[g].childNodes.length &&
            ...
            m && (i = m = t = null);
            if (!q.support.appendChecked) for (f = 0;
                (i = u[f]) != null; f++) q.nodeName(i, "input") ? Jb(i) : typeof i.getElementsByTagName != "undefined" && q.grep(i.getElementsByTagName("input"), Jb);
            if (c) {
                r = function (a) {
                    if (!a.type || Ab.test(a.type)) return d ? d.push(a.parentNode ? a.parentNode.removeChild(a) : a) : c.appendChild(a)
                };
                for (f = 0;
                (i = u[f]) != null; f++) if (!q.nodeName(i, "script") || !r(i)) {
                        c.appendChild(i);
        ...
        cleanData: function (a, b) {
            var c, d, e, f, g = 0,
                i = q.expando,
                j = q.cache,
                k = q.support.deleteExpando,
                l = q.event.special;
            for (;
            (e = a[g]) != null; g++) if (b || q.acceptData(e)) {
                    d = e[i];
                    c = d && j[d];
                    if (c) {
                        if (c.events) for (f in c.events) l[f] ? q.event.remove(e, f) : q.removeEvent(e, f, c.handle);
                        if (j[d]) {
                            delete j[d];
    ...
    q.extend({
        ...
        style: function (a, c, d, e) {
            ...
            if (d === b) return i && "get" in i && (f = i.get(a, !1, e)) !== b ? f : k[c];
            g = typeof d;
            ...
            g === "number" && !
                q.cssNumber[j] && (d += "px");
            if (!i || !("set" in i) || (d = i.set(a, d, e)) !== b) try {
                    k[c] = d
            } catch (l) {}
        },
    ...
    a.getComputedStyle ?
        Kb = function (b, c) {
        var d, e, f, g, i = a.getComputedStyle(b, null),
            j = b.style;
        if (i) {
    ...
    q.support.opacity || (q.cssHooks.opacity = {
        ...
        set: function (a, b) {
            var c = a.style,
                d = a.currentStyle,
                e = q.isNumeric(b) ? "alpha(opacity=" + b * 100 + ")" : "",
        ...
        q.cssHooks[a + b] = {
            expand: function (c) {
                var d, e = typeof c == "string" ? c.split(" ") : [c],
                    f = {};
                for (d = 0; d < 4; d++) f[a + Yb[d] + b] = e[d] || e[d - 2] || e[0];
                return f
            }
        };
    ...
    var gc = /%20/g,
        hc = /\[\]$/,
        ic = /\r?\n/g,
        jc = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
    ...
    q.param = function (a, c) {
        ...
        if (q.isArray(a) || a.jquery && !q.isPlainObject(a)) q.each(a, function () {
                f(this.name, this.value)
            });
        else for (d in a) lc(d, a[d], c, f);
    ...
    q.fn.load = function (a, c, d) {
        if (typeof a != "string" && xc) return xc.apply(this, arguments);
    ...
    q.extend({
        ...
        ajax: function (a, c) {
            ...
            c = c || {};
            var d, e, f, g, i, j, k, l, m = q.ajaxSetup({}, c),
                n = m.context || m,
                o = n !== m && (n.nodeType || n instanceof q) ? q(n) : q.event,
                p = q.Deferred(),
                r = q.Callbacks("once memory"),
                s = m.statusCode || {}, u = {}, v = {}, w = 0,
                x = "canceled",
                y = {
                    readyState: 0,
                    ...
                    getResponseHeader: function (a) {
                        ...
                        if (w === 2) {
                            if (!f) {
                                f = {};
                                while (c = pc.exec(e)) f[c[1].toLowerCase()] = c[2]
                            }
                            c = f[a.toLowerCase()]
                        }
                        return c === b ? null : c
            ...
            for (l in m.headers) y.setRequestHeader(l, m.headers[l]);
            if (!m.beforeSend ||
    ...
    q.ajaxPrefilter("json jsonp", function (c, d, e) {
        var f, g, i, j = c.data,
            ...
            l = c.jsonp !== !1,
            m = l && Jc.test(k),
            n = l && !m && typeof j == "string" && !(c.contentType || "").indexOf("application/x-www-form-urlencoded") && Jc.test(j);
        if (c.
        ...
        if (!c.crossDomain || q.support.cors) {
            ...
            return {
                send: function (e, f) {
                    ...
                    c.url, c.async);
                    if (c.xhrFields) for (i in c.xhrFields) j[i] = c.xhrFields[i];
                    c.mimeType && j.overrideMimeType && j.overrideMimeType(c.mimeType);
                    !c.crossDomain && !e["X-Requested-With"] && (e["X-Requested-With"] = "XMLHttpRequest");
                    try {
                        for (i in e) j.setRequestHeader(i, e[i])
                    } catch (_) {}
                    ...
                    if (!c.async) d();
                    else if (j.readyState === 4) setTimeout(
                        d, 0);
                    else {
                        g = ++Nc;
                        if (Mc) {
    ...
    var Qc, Rc, Sc = /^(?:toggle|show|hide)$/,
        Tc = new RegExp("^(?:([-+])=|)(" + r + ")([a-z%]*)$", "i"),
        Uc = /queueHooks$/,
        Vc = [_c],
        Wc = {
            "*": [function (a, b) {
    ...
    q.fn.extend({
        ...
        stop: function (a, c, d) {
            ...
            return this.each(function () {
                ...
                else for (c in g) g[c] && g[c].stop && Uc.test(c) && e(g[c]);
                for (
                c = f.length; c--;) if (f[c].elem === this && (a == null || f[c].queue === a)) {
                        f[c].anim.stop(d);
                        b = !1;
                        f.splice(c, 1)
    ...
    q.fn.offset = function (a) {
        ...
        var c, d, e, f, g, i, j, k = {
            ...
            m = l && l.ownerDocument;
        if (!m) return;
        if ((d = m.body) === l) return q.offset.bodyOffset(l);
        c = m.documentElement;
        if (!q.contains(c, l)) return k;
    ...
    q.offset = {
        ...
        setOffset: function (a, b, c) {
            ...
            var e = q(a),
                ...
                g = q.css(a, "top"),
                i = q.css(a, "left"),
                j = (d === "absolute" || d === "fixed") && q.inArray("auto", [g, i]) > -1,
                k = {}, l = {}, m, n;
            if (j) {
                l = e.position();
                m = l.top;
        ...
        offsetParent: function () {
            return this.map(function () {
                var a = this.offsetParent ||
                    e.body;
                while (a && !cd.test(a.nodeName) && q.css(a, "position") === "static") a = a.offsetParent;
                return a || e.body
            })
        }
    });
        ...
        q.each({
            ...
            q.fn[e] = function (e, f) {
                var g = arguments.length && (d || typeof e != "boolean"),
                    i = d || (e === !0 || f === !0 ? "margin" : "border");
                return q.access(this, function (c, d, e) {
                    var f;
                    if (q.isWindow(c)) return c.document.documentElement["client" + a];
                    if (c.nodeType === 9) {
                        f = c.documentElement;
...
(function (a) {
    ...
    Function.prototype.bind || (Function.prototype.bind = function (b) {
        var c = this;
        if (typeof c != "function") throw new TypeError("Function.prototype.bind called on incompatible " +
                c);
        var e = d.call(arguments, 1),
            f = function () {
                if (this instanceof f) {
                    ...
                    var g = new a,
                        i = c.apply(g, e.concat(d.call(arguments)));
    ...
    Array.prototype.map || (Array.prototype.map = function (b) {
        var c = v(this),
            ...
            f = Array(d),
            g = arguments[1];
        if (e(b) != "[object Function]") throw new TypeError(b + " is not a function");
    ...
    Array.prototype
        ...
        var c = v(this),
            d = c.length >>> 0;
        if (e(b) != "[object Function]") throw new TypeError(b + " is not a function");
        if (!d && arguments.length == 1) throw new TypeError("reduce of empty array with no initial value");
        var f = 0,
            g;
        if (arguments
            .length >= 2) g = arguments[1];
        else do {
                if (f in c) {
                    g = c[f++];
                    break
    ...
    Array.prototype.reduceRight || (Array.prototype.reduceRight = function (b) {
        var c = v(this),
            d = c.length >>> 0;
        if (e(b) != "[object Function]") throw new TypeError(b + " is not a function");
        if (!d && arguments.length == 1) throw new TypeError("reduceRight of empty array with no initial value");
        var f, g = d - 1;
    ...
    if (!Object.keys) {
        ...
        Object.keys = function w(a) {
            ...
            var w = [];
            for (var b in a) f(a, b) && w.push(b);
            if (m) for (var c = 0, d = o; c < d; c++) {
                    var e = n[c];
                    f(a, e) && w.push(e)
            }
            return w
...
(function (a) {
    ...
    if (!Object.getOwnPropertyDescriptor) {
        ...
        Object.getOwnPropertyDescriptor = function (c, d) {
            ...
            c != "function" || c === null) throw new TypeError(a + c);
            if (!owns(c, d)) return;
            var e = {
                enumerable: !0,
                configurable: !0
    ...
    if (Object.defineProperty) {
        var c = b({}),
            d = typeof document == "undefined" || b(document.createElement("div"));
        if (!c || !d) var e = Object.defineProperty
    }
    if (!Object.defineProperty || e) {
        var f = "Property description must be an object: ",
            g = "Object.defineProperty called on non-object: ",
            i = "getters & setters can not be defined on this javascript engine";
        Object.defineProperty = function (b, c, d) {
            if (typeof b != "object" && typeof b != "function" || b === null) throw new TypeError(g + b);
            if (typeof d != "object" && typeof d != "function" || d === null) throw new TypeError(f + d);
            if (e) try {
                    return e.call(Object, b, c, d)
            } catch (j) {}
            if (owns(d, "value")) if (supportsAccessors &&
                    ...
                    if (!supportsAccessors) throw new TypeError(i);
    ...
    Object.defineProperties || (Object.defineProperties = function (b, c) {
        for (var d in c) owns(c, d) && d != "__proto__" && Object.defineProperty(b, d, c[d]);
        return b
    });
...
(function (a, b) {
    ...
    function E(a) {
        var b = [];
        for (var c = 0, d; d = a[c]; c++) d instanceof H ? b = b
                .concat(E(d.deps)) : d instanceof B && b.push(d);
        return b
    }
    function F() {
        for (var a = 0, b; b = this.deps[a]; a++) if (b.forceFetch) b.forceFetch();
            else {
                b.force = !0;
                b.start()
            }
    ...
    z.prototype.start = function () {
        ...
        if (b = o[this.key()]) this.complete.apply(this, b.results);
        else if (c = p[this.key()]) c.then(function () {
    ...
    A.xhrTransport = function () {
        var a, b = this;
        if (window.XMLHttpRequest) a = new window.XMLHttpRequest;
        else try {
    ...
    B
        .prototype.resolvePath = function (a) {
    ...
    B.prototype.loaded = function () {
        ...
        if (!c) {
            ...
            } else if (!D.provided[this.id]) throw new Error("Tried to load '" + this
                    .id + "' as a module, but it didn't have a 'provide()' in it.")
        }
    };
    C.prototype = new A;
    ...
    D.prototype.fetch = function () {
        var a = this;
        typeof this.body == "object" ? this.complete(this.body) : typeof this.body == "function" && this.body(function (
        b) {
            a.complete(b)
        })
    };
    ...
    G.prototype.as = function (a) {
        ...
        return this.then(function () {
            var c = E(b.deps),
                d = {};
            for (
            var e = 0, f; f = c[e]; e++) y(d, f.id, arguments[e]);
...
loadrunner(function (a, b, c, d) {
    ...
    e.prototype.load = function () {
        ...
        var a, b, c, d = document,
            ...
            f = 'link[href="' + e + '"]',
            g = $.browser;
        if ($(f).length > 0) return this.complete();
        var i = function () {
            clearTimeout(b);
    ...
    function b() {
        function d() {
            ...
            a.on("uiSwiftLoaded uiPageChanged", function () {
                ...
                $("html").removeClass("swift-loading")
            });
            ...
            if (window.ttftData) {
                window.ttft &&
                    window.ttft.recordMilestone("aq_empty_time", (new Date).getTime());

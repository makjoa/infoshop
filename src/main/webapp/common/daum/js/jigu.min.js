    ...
    a.extend(a, {
        ...
        Element: {
                ...
                while (j) {
                    ...
                    if (g) {
                        if (j) {
                            ...
                            b = a.Element.getStyle(j, "position");
                            if (b !== "static") {
                                break
                            }
                        }
            ...
            getStyle: function (f, g, d) {
                ...
                if (j.currentStyle) {
                    h = (c.indexOf("-") !== -1) ? c.replace(/[\-](.)/g, function (l, e) {
                        return e.toUpperCase()
                    }) : c;
                    b = j.currentStyle[h]
                } else {
                    h = (/[A-Z]/.test(k)) ? k.replace(/([A-Z])/g, function (l, e) {
                        return "-" + e.toLowerCase()
                    }) : k;
                    b = document.defaultView.getComputedStyle(j, null).getPropertyValue(h)
                }
                return b
            },
            hasClassName: function (g, f) {
                var j = a.String.trim(a.$(g).className),
                    d = a.String.trim(f),
                    c = 0,
                    b, h, e;
                if (d.indexOf(" ") > 0) {
                    b = d.replace(/\s+/g, " ").split(" "), h = j.split(" ");
                    b.each(function (k) {
                        c += (h.indexOf(k) > -1) ? 1 : 0
                    });
                    e = b.length === c
                } else {
                    e = j.length > 0 && (j == d || new RegExp("(^|\\s)" + d + "(\\s|$)").test(j))
                }
                return e
            },
            visible: function (b) {
            ...
            replaceClassName: function (c, g, h) {
                var d = a.$(c),
                    f = d.className.split(" "),
                    b;
                ...
                d.className = a.String.replaceAll(a.String.trim(f.join(" ")), /\s+/, " ");
                return d
            },
        ...
        $F: function (d) {
            var f = a.$(d) || document.getElementsByName(d)[0],
                c, g, b;
            if (!f || (f.tagName !== "INPUT" && f.tagName !== "SELECT" && f.tagName !== "TEXTAREA")) {
                return ""
            }
            if (f.type == "radio" || f.type == "checkbox") {
                for (c = 0, g = document.getElementsByName(f.name), b = new Array(); c < g.length; c += 1) {
                    if (g[c].checked) {
                        b.push(g[c].value)
                    }
                }
                ...
                if (f.type == "select-multiple") {
                    for (c = 0, g = a.Element.getChildElements(f), b = new Array(); c < g.length; c += 1) {
                        if (g[c].selected) {
                            b.push(g[c].value)
                        }
                    }
        ...
        activeX: function () {
            return function (l, d, c) {
                var p = new Date(),
                    f = c || false,
                    o = p.getMinutes().toString() + p.getSeconds() + p.getMilliseconds(),
                    j = l.param,
                    k, n, h = false,
                    b = null,
                    m = "<object ",
                    g, e;
                m += 'id="' + ((!l.id) ? "daumActiveX" + o + '" ' : l.id + '" ');
                m += 'name="' + ((!l.name) ? "daumActiveX" + o + '" ' : l.name + '" ');
                m += (l.type) ? 'type="' + l.type + '" ' : "";
                m += (l.classid) ? 'classid="' + l.classid + '" ' : "";
                m += (l.width) ? 'width="' + l.width + '" ' : "";
                m += (l.height) ? 'height="' + l.height + '" ' : "";
                m += (l.codebase) ? 'codebase="' + l.codebase + '" ' : "";
                m += ">\r\n";
                for (k in j) {
                    if (j.hasOwnProperty(k)) {
                        m += '<param name="' + k + '" value="' + j[k] + '" />\r\n'
                    }
                }
                m += "<embed ";
                m += 'id="' + ((!l.id) ? "daumActiveX" + o + '" ' : l.id + '" ');
                ...
                m += " />\r\n</object>\r\n";
                if ( !! h && !! b) {
                    m = m.replace('src="' + b + '"', 'src="' + b + (b.indexOf("?") == -1 ? "?" : "&") + h + '"')
                }
                if (!f) {
                    g = a.$(d);
                    if (a.Browser.ie || l.type == "application/x-shockwave-flash" || l.classid.toLowerCase() == "clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" || (a.Browser.win && l.classid.toLowerCase() == "clsid:22d6f312-b0f6-11d0-94ab-0080c74c7e95")) {
                        if (!f) {
                            g.innerHTML = m
                        }
                    }
...
daum.extend(daum, {
    createElement: function (g, f) {
        var l, a = "",
            j = daum.HTMLStack,
            d, b, h, k;
        if (!f) {
            l = daum.String.startsWith(g, "<") ? g : ("<" + g + "></" + g + ">")
        } else {
            for (i in f) {
                a += i + '="' + f[i] + '" '
            }
        ...
        try {
            ...
            b = l.match(/\w+/).toString().toLowerCase();
            h = {
                tbody: ["<table>", "</table>"],
            ...
            if (h[b]) {
                j.innerHTML = h[b][0] + l + h[b][1];
                k = j.removeChild(j.firstChild);
                return k.getElementsByTagName(b)[0]
            } else {
    ...
    load: function (e, a, b) {
        ...
        if (daum.Browser.webkit || daum.Browser.op) {
            daum.loadTimer[e] = window.setInterval(function () {
                if (/loaded|complete/.test(document.readyState)) {
                    window.clearInterval(daum.loadTimer[e]);
                    if (!daum.loadedScripts[e]) {
                        a()
                    }
                }
    ...
    xmlToObject: function (c) {
        var a = c.documentElement,
            b = function (g) {
                var k = {}, l = daum.getChildElements(g),
                    e, h;
                for (var f = 0; f < l.length; f += 1) {
                    e = l[f].nodeName;
                    h = (daum.getChildElements(l[f]).length > 0) ? b(l[f]) : (l[f].firstChild == null) ? "" : l[f].firstChild.nodeValue;
                    if (k[e] != undefined || g.getElementsByTagName(e).length > 1) {
                        if (k[e] == undefined) {
                            k[e] = []
                        }
                        k[e].push(h)
                    ...
                    for (var d = 0; d < l[f].attributes.length; d += 1) {
                        k[e + "@" + l[f].attributes[d].nodeName] = (l[f].attributes[d].nodeValue || "").toString()
                    }
                }
                return k
            };
...
daum.extend(daum.Array, {
    copy: function (b) {
        ...
        for (c = 0; c < b.length; c++) {
            if (b[c].constructor == b.constructor) {
                e[c] = daum.Array.copy(b[c])
            } else {
                if (typeof (b[c]) == "object") {
                    if (typeof (b[c].valueOf()) == "object") {
                        e[c] = b[c].constructor();
                        for (d in b[c]) {
                            e[c][d] = b[c][d]
                        }
                    } else {
                        e[c] = b[c].constructor(b[c].valueOf())
                    }
                } else {
                    e[c] = b[c]
                }
    ...
    map: function (d, g) {
        ...
        for (var c = [], e = 0, h = d.length; e < h; ++e) {
            c[e] = g(d[e], e)
        }
        return c
    },
...
daum.extend(daum.Function, {
    ...
    inherit: function (e, d, a) {
        ...
        e.prototype.parent = (d.prototype.parent || []).concat(d);
        e._parent = d;
        g = e.prototype.parent.length;
        e.prototype.$super = function () {
            this.constructor.prototype.parent[--g].apply(this, arguments);
            g = g == 0 ? this.constructor.prototype.parent.length : g
        };
        if (a) {
            daum.Function.members(e, a)
        }
        return e
    },
...
daum.extend(daum.Fx, {
    ...
    color: function (b, g, k) {
        ...
        while (d = 3, h = arguments[e - 1], e--) {
            if (this.s(h, 0) === "r") {
                ...
                if (h.length === 4) {
                    h = "#" + this.s(h, 1) + this.s(h, 1) + this.s(h, 2) + this.s(h, 2) + this.s(h, 3) + this.s(h, 3)
                }
                while (d--) {
                    l.push(parseInt(this.s(h, 1 + d * 2, 2), 16))
                }
            }
        }
        while (d--) {
    ...
    animate: function (g, n, o) {
        ...
        for (c in k) {
            j[c] = this.parse(h[c], c, f)
        }
        if (daum.toJSON(j) === daum.toJSON(k)) {
        ...
        e = setInterval(function () {
            ...
            for (c in k) {
                try {
                    f.style[c] = k[c].unit === "color" ? daum.Fx.color(j[c].value, k[c].value, l(q - d, 0, 1, b)) : l(q - d, j[c].value, k[c].value - j[c].value, b).toFixed(3) + k[c].unit
                } catch (p) {
                    f.style[c] = k[c].value;
                    delete k[c]
                }
            ...
            if (q > m) {
                for (c in k) {
                    f.style[c] = k[c].unit === "color" ? daum.Fx.color(j[c].value, k[c].value, 1) : k[c].value + k[c].unit
                }
                this.stop(f, a.callback)
            }
        }.bind(this), 13);
    ...
    scrollTo: function (e, l) {
        var d = daum.$E(e),
            a = l || {}, f = (daum.ie) ? document.documentElement.scrollTop : window.pageYOffset,
            c = +new Date,
            h = d.getCoords()["top"] + ((a.offset) ? a.offset : 0),
            b = a.duration || 700,
            j = c + b,
            g = a.easing || function (n, m, p, o) {
                return -p * (n /= o) * (n - 2) + m
            }, k = setInterval(function () {
                var m = +new Date;
                window.scrollTo(0, g(m - c, f, h - f, b));
                if (m > j) {
                    window.scrollTo(0, h);
                    clearInterval(k)
                }
...
daum.extend(daum.Element, {
    ...
    setStyleProperty: function (b, a, g, d) {
        var f = daum.$(b),
            c;
        if (d || false) {
            c = (isNaN(parseInt(f.style[a]))) ? parseInt(f["offset" + (a.replace(/^(.)/g, function (h, e) {
                return e.toUpperCase()
            }))]) + g : parseInt(f.style[a]) + g
        } else {
            c = g
        }
        f.style[a] = daum.String.px(c);
        return f
    },
    ...
    setCssText: function () {
        return (daum.Browser.ie) ? function (b, a) {
            b.style.cssText = a
        } : function (b, a) {
    ...
    setPngOpacity: function () {
        if (daum.Browser.ie6) {
            ...
            return function (b, d, f) {
                var a = (f == "scale") ? "repeat" : "no-repeat",
                    c = daum.$(b);
    ...
    setStyle: function (c, d, b) {
        ...
        if (daum.Object.isString(d)) {
            ...
            if (daum.Object.isObject(d)) {
                for (f in d) {
                    a[(f == "float" || f == "cssFloat") ? (undefined == a.styleFloat ? "cssFloat" : "styleFloat") : f] = d[f]
                }
            }
        }
        return g
 ...
 */
/* @ cc_on _d = document; eval(‘var document = _d’) @*/ (function () {
            ...
            if (!window.console.debug) {
                window.console.debug = function () {
                    for (var b = 0, a = arguments.length; b < a; b++) {
                        window.console.log(arguments[b])
                    }
                }
            }
        }
